...
def main():
    ...
    if near_duplicates:
        ...
        for i, near_dup in enumerate(near_duplicates[:10], 1):  # Show first 10
            ...
            print(f"File 1: {near_dup['insight1']['file']} ({near_dup['insight1']['planet']} in {near_dup['insight1']['sign']})")
            print(f"File 2: {near_dup['insight2']['file']} ({near_dup['insight2']['planet']} in {near_dup['insight2']['sign']})")
