...
class ExpressionKasperConverter:
    ...
    def convert_expression_file(self, input_path: Path, number: int) -> Dict[str, Any]:
        ...
        kasper_data["trinity"]["calculation"] = "Sum all letters of the full birth name; reduce to a single digit or master number"
        kasper_data["trinity"]["meaning"] = "Represents your natural communication style, talents, and how you express yourself in the world"
        ...
        kasper_data["generation_instructions"]["focus"] = "Natural communication style, talents, and self-expression in the world"
