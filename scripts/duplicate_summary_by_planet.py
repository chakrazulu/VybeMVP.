...
def main():
    ...
    planet_dirs = [
        'Mars_Combinations', 'Venus_Combinations', 'Sun_Combinations', 'Moon_Combinations',
        'Mercury_Combinations', 'Jupiter_Combinations', 'Saturn_Combinations', 
        'Uranus_Combinations', 'Neptune_Combinations', 'Pluto_Combinations'
    ]
    ...
    for text, duplicates in exact_duplicates.items():
        ...
        for planet in planets_affected:
            ...
            if planet_duplicate_count > 1:  # Only count if there are actual duplicates within the planet
    ...
    total_planets_affected = len([p for p in planet_duplicate_counts.keys() if planet_duplicate_counts[p] > 0])
