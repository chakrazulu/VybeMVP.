...
class MarsArchetypalBalancer:
    ...
    def __init__(self, base_path: str = None):
        ...
        self.input_dir = (
            self.base_path / "NumerologyData" / "FirebasePlanetZodiacFusion" / "Mars_Combinations"
        )

        # Mars archetypal essence patterns (same as original system)
        self.mars_archetypal_cores = {
            "warrior_expressions": [
                "sacred_warrior_activation",
                "divine_action_mastery",
                "spiritual_courage_embodiment",
                "martian_energy_direction",
                "sacred_assertiveness_flow",
                "divine_will_expression",
                "warrior_consciousness_awakening",
                "sacred_battle_wisdom",
                "divine_action_precision",
                "martian_leadership_emergence",
                "sacred_strength_cultivation",
                "divine_warrior_mastery",
            ],
            "martian_powers": [
                "sacred_courage",
                "divine_action",
            ...
            "warrior_cadences": [
                "martian_warrior_awakening",
                "sacred_action_emergence",
                "divine_courage_flow",
                "warrior_wisdom_guidance",
                "sacred_strength_rhythm",
                "divine_will_expression",
                "martian_leadership_emergence",
                "sacred_battle_mastery",
                "divine_action_precision",
                "warrior_consciousness_awakening",
                "sacred_assertiveness_flow",
                "divine_warrior_mastery",
        ...
        self.persona_focuses = {
            "Soul Psychologist": [
                "warrior_psychology_healing",
                "action_consciousness_therapy",
                "courage_pattern_healing",
                "assertiveness_therapy",
                "warrior_mindset_healing",
                "action_pattern_integration",
            ],
            "Mystic Oracle": [
                "martian_mystical_wisdom",
                "warrior_oracle_guidance",
                "action_prophetic_insight",
                "courage_spiritual_messages",
                "warrior_mystical_transmission",
                "action_oracle_wisdom",
            ],
            "Energy Healer": [
                "martian_energy_activation",
                "warrior_vibration_work",
                "action_frequency_alignment",
                "courage_energy_healing",
                "warrior_chakra_activation",
                "action_energy_transmission",
            ],
            "Spiritual Philosopher": [
                "warrior_spiritual_philosophy",
                "action_consciousness_teachings",
                "courage_philosophical_guidance",
                "martian_wisdom_understanding",
                "warrior_spiritual_synthesis",
                "action_consciousness_transmission",
            ],
        }
    ...
    def generate_additional_mars_insight(
    ...
    def balance_mars_system(self):
        ...
        for i, file_path in enumerate(sorted(mars_files)):
            ...
            print(
                f"✅ Added {insights_to_add} insights to Mars in {sign} (now {data['total_insights']} total)"
            )
...
def main():
    ...
    try:
        ...
        print("\n🎯 BALANCE SUMMARY:")
        print("   ⚔️ Mars Archetypal Warrior System: BALANCED")
        print(f"   📈 Final Total Quality Insights: {final_total}")
        print("   🎪 All 12 Sacred Warrior Voices: EXPANDED")
        print("   ⚡ Mars Now Matches Other Planetary Systems")
