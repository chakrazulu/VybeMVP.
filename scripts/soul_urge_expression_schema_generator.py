...
class SoulUrgeExpressionGenerator:
    ...
    def generate_soul_urge_content(self, number: int) -> Dict[str, Any]:
        ...
        soul_urge_insights = {
            ...
            3: {
                ...
                "key_desires": ["Artistic fulfillment", "Social connection", "Inspirational sharing"],
            ...
            11: {
                ...
                "key_desires": ["Spiritual teaching", "Intuitive guidance", "Inspirational service"],
            ...
            22: {
                ...
                "key_desires": ["Large-scale impact", "Spiritual architecture", "World transformation"],
            ...
            44: {
                ...
                "key_desires": ["Spiritual systems", "Organized service", "Material-spiritual integration"],
    ...
    def generate_all_soul_urge_files(self):
        ...
        print("=" * 50)
        print(f"Using validated Expression schema structure")
        ...
        for number in numbers:
            try:
                ...
                print(f"✅ Generated: {filename} ({len(soul_urge_data['profiles'][0]['behavioral'])} categories)")
