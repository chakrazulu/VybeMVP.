        ...
        for category in categories:
            if category in original_behavioral:
                ...
                for insight in insights:
                    converted_insight = self.convert_insight_to_soul_urge_focus(insight, category, number)
                    v2_data["behavioral_insights"].append(converted_insight)
        
        return v2_data
    
    def convert_insight_to_soul_urge_focus(self, insight: Dict, category: str, number: int) -> Dict[str, Any]:
