...
class TestManifest(unittest.TestCase):
    ...
    def test_manifest_includes_all_files(self):
        ...
        self.assertEqual(
            ...
            f"Files missing from MANIFEST: {missing_from_manifest}"
        )
    ...
    def test_dataset_digest(self):
        ...
        # Check format
        self.assertEqual(
            len(dataset_digest), 64,
            f"Dataset digest has wrong length: {len(dataset_digest)}"
        )
    ...
    def test_manifest_metadata(self):
        ...
        required_fields = [
            'manifest_version', 'generated_at', 'dataset_name',
            'dataset_version', 'total_files', 'total_bytes', 'dataset_digest'
        ]
